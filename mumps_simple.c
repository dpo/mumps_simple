...
void* mumps_initialize_float(int sym, int* icntl, float* cntl) {

  SMUMPS_STRUC_C* pmumps;
  int i;
...
void* mumps_initialize_float_complex(int sym, int* icntl, float* cntl) {

  CMUMPS_STRUC_C* pmumps;
  int i;
  ...
  // Initialize MUMPS.
  mumps_alloc_float_complex(&pmumps);
  if (pmumps == NULL) return NULL;
...
void mumps_associate_matrix_float(void* jmumps, int n, int nz,
                                  float* vals, int* irow, int* jcol) {
...
void mumps_associate_matrix_float_complex(void* jmumps, int n, int nz,
                                          float complex* vals, int* irow, int* jcol) {
...
void mumps_factorize_float(void* jmumps) {
...
void mumps_factorize_float_complex(void* jmumps) {
...
// This is a separate function so users can call it
// only on the host if necessary.
void mumps_associate_rhs_float(void* jmumps, int nrhs, float* rhs) {
...
void mumps_associate_rhs_float_complex(void* jmumps, int nrhs, float complex* rhs) {

  CMUMPS_STRUC_C* pmumps = (CMUMPS_STRUC_C*)jmumps;

  pmumps->nrhs = nrhs;
  pmumps->lrhs = pmumps->n;
  pmumps->rhs  = (mumps_complex*)rhs;  // Will be overwritten with the solution.
}
...
void mumps_solve_float(void* jmumps, int* transposed) {
...
void mumps_solve_float_complex(void* jmumps, int* transposed) {
...
// This is a separate function so users can call it
// only on the host if necessary.
void mumps_get_solution_float(void* jmumps, float* x) {
...
void mumps_get_solution_float_complex(void* jmumps, float complex* x) {
...
int mumps_get_nrhs_float(void* jmumps) {
...
int mumps_get_nrhs_float_complex(void* jmumps) {
...
void mumps_get_info_float(void* jmumps, int* infog, float* rinfog) {
...
void mumps_get_info_float_complex(void* jmumps, int* infog, float* rinfog) {
...
void mumps_finalize_float(void* jmumps) {
...
void mumps_finalize_float_complex(void* jmumps) {
  ...
  pmumps->job = JOB_END;
  cmumps_c(pmumps);
  mumps_free_float_complex(&pmumps);
...
void mumps_alloc_float(SMUMPS_STRUC_C** mumps){

  (*mumps) = malloc(sizeof(SMUMPS_STRUC_C));
...
void mumps_alloc_float_complex(CMUMPS_STRUC_C** mumps){

  (*mumps) = malloc(sizeof(CMUMPS_STRUC_C));
  if (*mumps == NULL) return;
...
void mumps_free_float(SMUMPS_STRUC_C** mumps){
  if (*mumps != NULL){
    Free( (*mumps)->irn_loc );
    Free( (*mumps)->jcn_loc );
    Free( (*mumps)->a_loc );
...
void mumps_free_float_complex(CMUMPS_STRUC_C** mumps){
  if (*mumps != NULL){
    Free( (*mumps)->irn_loc );
    Free( (*mumps)->jcn_loc );
    Free( (*mumps)->a_loc );
